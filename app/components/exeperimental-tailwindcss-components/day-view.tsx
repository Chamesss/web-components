...
export default function DayView() {
    ...
    return (
        <div className="flex h-full w-full flex-col bg-red-200">
            ...
            <div className="isolate flex flex-auto overflow-hidden bg-blue-200">
                <div
                    ref={container}
                ...
                >
                    ...
                    <div className="flex w-full flex-auto bg-green-200">
